...
/* "xiangqigame/cython_modules/get_color.pyx":4
 * 
...
static long __pyx_f_11xiangqigame_14cython_modules_9get_color_get_color(long, long, __Pyx_memviewslice); /*proto*/
...
/* "xiangqigame/cython_modules/get_color.pyx":12
...
static long __pyx_f_11xiangqigame_14cython_modules_9get_color_get_color(long __pyx_v_rank, long __pyx_v_file, __Pyx_memviewslice __pyx_v_board_map) {
  long __pyx_r;
  ...
  /* "xiangqigame/cython_modules/get_color.pyx":16
 *         long file,
 *         long [:, :] board_map):
 ...
 */
  ...
  __pyx_r = ((0 < (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_board_map.data + __pyx_t_1 * __pyx_v_board_map.strides[0]) ) + __pyx_t_2 * __pyx_v_board_map.strides[1]) )))) - ((*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_board_map.data + __pyx_t_3 * __pyx_v_board_map.strides[0]) ) + __pyx_t_4 * __pyx_v_board_map.strides[1]) ))) < 0));
  goto __pyx_L0;
...
/* "xiangqigame/cython_modules/get_color.pyx":21
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
 * def run_get_color(             # <<<<<<<<<<<<<<
 *         long rank,
...
static PyObject *__pyx_pw_11xiangqigame_14cython_modules_9get_color_1run_get_color(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("run_get_color (wrapper)", 0);
  {
    ...
    __pyx_v_board_map = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_board_map.memview)) __PYX_ERR(0, 24, __pyx_L3_error)
  }
...
static PyObject *__pyx_pf_11xiangqigame_14cython_modules_9get_color_run_get_color(CYTHON_UNUSED PyObject *__pyx_self, long __pyx_v_rank, long __pyx_v_file, __Pyx_memviewslice __pyx_v_board_map) {
  ...
  /* "xiangqigame/cython_modules/get_color.pyx":25
 *         long file,
 *         long [:, :] board_map):
 *     return get_color(rank=rank, file=file, board_map=board_map)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_11xiangqigame_14cython_modules_9get_color_get_color(__pyx_v_rank, __pyx_v_file, __pyx_v_board_map)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 *         long file,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_11xiangqigame_14cython_modules_9get_color_1run_get_color, NULL, __pyx_n_s_xiangqigame_cython_modules_get_c_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_run_get_color, __pyx_t_1) < 0) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
