...
static void __pyx_f_11xiangqigame_14cython_modules_13search_spaces_search_spaces(__Pyx_memviewslice, long *, long *, long *, long *, long *, long *); /*proto*/
...
static void __pyx_f_11xiangqigame_14cython_modules_13search_spaces_search_spaces(__Pyx_memviewslice __pyx_v_board_map, long *__pyx_v_start, long *__pyx_v_search_direction, long *__pyx_v_num_empty_spaces, long *__pyx_v_empty_spaces, long *__pyx_v_has_first_occ_space, long *__pyx_v_first_occupied) {
 ...
 */
    ...
    __pyx_t_4 = (((*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_board_map.data + __pyx_t_6 * __pyx_v_board_map.strides[0]) ) + __pyx_t_7 * __pyx_v_board_map.strides[1]) ))) == __pyx_e_11xiangqigame_14cython_modules_13search_spaces_NUL) != 0);
    __pyx_t_2 = __pyx_t_4;
...
static PyObject *__pyx_pw_11xiangqigame_14cython_modules_13search_spaces_1run_search_space(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("run_search_space (wrapper)", 0);
  {
    ...
    __pyx_v_board_map = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_board_map.memview)) __PYX_ERR(0, 61, __pyx_L3_error)
