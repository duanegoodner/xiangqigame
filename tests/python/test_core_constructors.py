...
class TestCoreConstructors:
    ...
    # def test_minimax_move_evaluator_new(self):
    #     game_board = bindings.GameBoard()
    #     game_position_points = bindings.PiecePositionPoints()
    #
    #     primary_calculator_032 = bindings.ZobristCalculator64()
    #     confirmation_calculators_032 = [bindings.ZobristCalculator64()]
    #     zobrist_component_032 = bindings.ZobristComponentNew64(
    #         primary_calculator=primary_calculator_032,
    #         confirmation_calculators=confirmation_calculators_032,
    #     )
    #
    #     primary_calculator_064 = bindings.ZobristCalculator64()
    #     confirmation_calculators_064 = [bindings.ZobristCalculator64()]
    #     zobrist_component_064 = bindings.ZobristComponentNew64(
    #         primary_calculator=primary_calculator_064,
    #         confirmation_calculators=confirmation_calculators_064,
    #     )
    #
    #     primary_calculator_128 = bindings.ZobristCalculator64()
    #     confirmation_calculators_128 = [bindings.ZobristCalculator64()]
    #     zobrist_component_128 = bindings.ZobristComponentNew64(
    #         primary_calculator=primary_calculator_128,
    #         confirmation_calculators=confirmation_calculators_128,
    #     )
    #
    #     move_sorter = bindings.PreSearchMoveSorter(
    #         game_board=game_board, game_position_points=game_position_points
    #     )
    #
    #     minimax_move_evaluator_new_032 = bindings.MinimaxMoveEvaluator32New(
    #         evaluator=bindings.PieceColor.kRed,
    #         search_depth=4,
    #         game_board=game_board,
    #         game_position_points=game_position_points,
    #         hash_calculator=
    #
    #     )
