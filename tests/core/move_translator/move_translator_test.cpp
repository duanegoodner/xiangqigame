...
protected:
  std::string valid_input_a_{"a4, a5"};
  std::string invalid_input_b_{"a4a5"};

  std::istringstream valid_input_stream_a_;
  std::istringstream invalid_input_stream_b_;

  std::vector<std::string> valid_parsed_input_a_{"a4", "a5"};
  std::vector<std::string> invalid_parsed_input_b_{"a4a5"};

  gameboard::BoardSpace board_space_a_start_{6, 0};
  gameboard::BoardSpace board_space_a_end_{5, 0};
