...
from xiangqigame_core import MinimaxMoveEvaluator, RandomMoveEvaluator
...
class XiangqiGameCommandLine:
    ...
    def _attach_args(self):
        self._parser.add_argument(
            "-rt", "--red_player_type", choices=["person", "ai"],
            help="Can be 'person', or 'ai'. Default is 'ai'.")

        self._parser.add_argument(
            "-ra", "--red_algo", choices=["random", "minimax"], required=False,
        ...
        self._parser.add_argument(
            "-bt", "--black_player_type", choices=["person", "ai"],
            help="Can be 'person', or 'ai'. Default is 'ai'."
        )

        self._parser.add_argument(
            "-ba", "--black_algo", choices=["random", "minimax"],
            required=False,
    ...
    def get_args(self, *args):
        ...
        interpreted_command = XiangqiGameCommandInterpreter(args_namespace).interpret_command()
