...
@dataclass
class EqualValueMoves:
    best_eval: PointsT
    best_moves: MoveCollection

    @classmethod
    def from_core_best_moves(cls, core_best_moves: core.EqualValueMoves):
        return cls(
...
class SearchSummary:
    ...
    def from_core_search_summary(cls, core_search_summary: core.SearchSummary):
        return cls(
            ...
            best_moves=EqualValueMoves.from_core_best_moves(
