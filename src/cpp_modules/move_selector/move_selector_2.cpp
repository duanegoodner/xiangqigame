...
MinimaxMoveSelectorInterface<MinimaxEvaluator>::MinimaxMoveSelectorInterface(
...
template <typename MinimaxEvaluator>
void MinimaxMoveSelectorInterface<MinimaxEvaluator>::ResetNodeCounter()
{
    node_counter_ = 0;
}

template <typename MinimaxEvaluator>
vector<RatedMove> MinimaxMoveSelectorInterface<MinimaxEvaluator>::GenerateRankedMoveList(
    GameBoard &game_board,
    PieceColor cur_player,
...
template <typename MinimaxEvaluator>
BestMoves MinimaxMoveSelectorInterface<MinimaxEvaluator>::MinimaxRec(
    GameBoard &game_board,
    int search_depth,
    int alpha,
    int beta,
...
template <typename MinimaxEvaluator>
Move MinimaxMoveSelectorInterface<MinimaxEvaluator>::ImplementSelectMove(
    GameBoard &game_board,
    PieceColor cur_player,
    MoveCollection &cur_moves)
{
