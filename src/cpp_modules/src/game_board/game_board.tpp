...
// ************ UpdateHashCalculator for GameBoard and NewGameBoard ************
...
// ************ AddToMoveLog for GameBoard and NewGameBoard ************
...
template <typename ConcreteBoardStateSummarizer>
void NewGameBoard<ConcreteBoardStateSummarizer>::AddToMoveLog(ExecutedMove executed_move
) {
  auto piece_color = executed_move.moving_piece.piece_color;
  move_log_[piece_color].push_back(executed_move);
}
...
// ************ RemoveFromMoveLog for GameBoard and NewGameBoard ************
...
template <typename ConcreteBoardStateSummarizer>
ExecutedMove NewGameBoard<ConcreteBoardStateSummarizer>::ImplementExecuteMove(Move move
) {
  auto moving_piece = GetOccupant(move.start);
  auto destination_piece = GetOccupant(move.end);
  SetOccupant(move.end, moving_piece);
...
// ************ ImplementUndoMove for GameBoard and NewGameBoard ************
...
// ************ ImplementGetAllSpacesOccupiedBy for GameBoard and NewGameBoard ************
...
// ************ SetOccupant for GameBoard and NewGameBoard ************
...
// ************ IsInCheck for GameBoard and NewGameBoard ************
...
// ************ ImplementCalcFinalMOvesOf for GameBoard and NewGameBoard ************
...
template <typename ConcreteBoardStateSummarizer>
MoveCollection NewGameBoard<ConcreteBoardStateSummarizer>::ImplementCalcFinalMovesOf(
    PieceColor color
) {
  auto un_tested_moves =
      move_calculator_.CalcAllMovesNoCheckTest(color, board_map_);
...
// ************ ImplementGetColor for GameBoard and NewGameBoard ************
...
// ************ ImplementGetType for GameBoard and NewGameBoard ************
...
template <typename ConcreteBoardStateSummarizer>
PieceType NewGameBoard<ConcreteBoardStateSummarizer>::ImplementGetType(BoardSpace space
) {
  return get_type(board_map_, space);
}
...
// ************ ImplementSearchTranspositionTable for GameBoard and NewGameBoard ************
...
// ************ ImplementRecordCurrentStateScore for GameBoard and NewGameBoard ************
...
template <typename ConcreteBoardStateSummarizer>
void NewGameBoard<ConcreteBoardStateSummarizer>::ImplementRecordCurrentStateScore(
    PieceColor color,
    int search_depth,
    MinimaxResultType result_type,
    BestMoves &best_moves
...
// ************ ViolatesRepeatRule for GameBoard and NewGameBoard ************
...
template <typename ConcreteBoardStateSummarizer>
bool NewGameBoard<ConcreteBoardStateSummarizer>::ViolatesRepeatRule(PieceColor color) {
  for (auto period_length : kRepeatPeriodsToCheck) {
    auto lookback_length = (kMaxAllowedRepeatPeriods + 1) * period_length;
    if (utility_functs::hasRepeatingPattern(
            move_log_[color],
